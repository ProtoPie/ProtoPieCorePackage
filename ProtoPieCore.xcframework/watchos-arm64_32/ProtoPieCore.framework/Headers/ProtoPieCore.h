...
- (void)changeBackgroundColorLayer:(PPCPPLayer *)layer __attribute__((swift_name("changeBackgroundColor(layer:)")));
...
- (NSString *)epochtodateTimestamp:(int64_t)timestamp __attribute__((swift_name("epochtodate(timestamp:)")));
