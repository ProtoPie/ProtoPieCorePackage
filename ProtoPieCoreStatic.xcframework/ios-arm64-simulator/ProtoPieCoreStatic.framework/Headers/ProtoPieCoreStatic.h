...
@class PPCSAbstractMediaLayer, PPCSAbstractTextLayer, PPCSCommon, PPCSDeviceDesc, PPCSDeviceDescCompanion, PPCSDeviceFrameHelper, PPCSDevicePreset, PPCSFormulaUtils, PPCSKotlinArray<T>, PPCSKotlinEnum<E>, PPCSKotlinEnumCompanion, PPCSKotlinException, PPCSKotlinFloatArray, PPCSKotlinFloatIterator, PPCSKotlinNothing, PPCSKotlinThrowable, PPCSKotlinx_serialization_coreSerialKind, PPCSKotlinx_serialization_coreSerializersModule, PPCSKotlinx_serialization_jsonJsonElement, PPCSKotlinx_serialization_jsonJsonElementCompanion, PPCSLogLevel, PPCSLogger, PPCSMediaState, PPCSMediaStateCompanion, PPCSPPAndroidVibrateType, PPCSPPAxis3D, PPCSPPBlurEffectStyle, PPCSPPBorderPosition, PPCSPPCameraLayerCommand, PPCSPPCameraPosition, PPCSPPChangeObserversHolder, PPCSPPChangeTarget, PPCSPPClock, PPCSPPColor, PPCSPPColorCompanion, PPCSPPColorProperty, PPCSPPContainerLayer, PPCSPPCorners<T>, PPCSPPDataType, PPCSPPDeviceFrameType, PPCSPPDeviceInfo, PPCSPPDeviceInfoCompanion, PPCSPPEventChannel<T>, PPCSPPExpr, PPCSPPExprEvalError, PPCSPPExprEvalErrorCompanion, PPCSPPExprParseError, PPCSPPExprParseErrorCompanion, PPCSPPFillScaleMode, PPCSPPFixedSceneChangeEventCompanion, PPCSPPFloatCorners, PPCSPPFloatProperty, PPCSPPFont, PPCSPPHitArea, PPCSPPHorizontalAlign, PPCSPPId, PPCSPPIdCompanion, PPCSPPIdentifiableChangeObservable, PPCSPPInputFocusEventCompanion, PPCSPPIosEffectEventCompanion, PPCSPPIosVibrateType, PPCSPPJsonImpl, PPCSPPJsonPool, PPCSPPJsonStringBacked, PPCSPPKeyCode, PPCSPPKeyCodeCompanion, PPCSPPKotlinGC, PPCSPPLayer, PPCSPPLayerAlias, PPCSPPLayerCompanion, PPCSPPLayerLayoutBBox, PPCSPPLayerProperty, PPCSPPLayerType, PPCSPPLayerViewSplitterCompanion, PPCSPPLayerViewSplitterGroup, PPCSPPLineCap, PPCSPPLineJoin, PPCSPPMediaCommand, PPCSPPMediaCommandCompanion, PPCSPPMediaCommandEventCompanion, PPCSPPMessage, PPCSPPMessageBus, PPCSPPMessageCompanion, PPCSPPMsg, PPCSPPMsgChannel, PPCSPPMsgCompanion, PPCSPPNumberConstantExpr, PPCSPPPathSegmentData, PPCSPPPathSegmentType, PPCSPPPieContext, PPCSPPPieModel, PPCSPPPieModelCompanion, PPCSPPPiePlayerEvent, PPCSPPPiePlayerEventTextInputFocusedIn, PPCSPPPiePlayerEventTextInputFocusedOut, PPCSPPPieRecord, PPCSPPPlatformType, PPCSPPPlayControlGestureOptions, PPCSPPPlayEvent, PPCSPPPlayEventCompanion, PPCSPPPoint, PPCSPPPointCompanion, PPCSPPProperty<T>, PPCSPPRenderEvent, PPCSPPRenderEventCompanion, PPCSPPReorderEventCompanion, PPCSPPRepeatDef, PPCSPPScene, PPCSPPSceneChangeEvent, PPCSPPSceneChangeEventCompanion, PPCSPPSensor, PPCSPPShapeLayer, PPCSPPSharedComponentContainerLayer, PPCSPPSharedComponentContainerLayerCompanion, PPCSPPSize, PPCSPPSpeechGender, PPCSPPStringProperty, PPCSPPTextAttributes, PPCSPPTextAttributesCompanion, PPCSPPTextInputLayer, PPCSPPTextInputLayerKeyboardLook, PPCSPPTextInputLayerKeyboardType, PPCSPPTextInputLayerReturnKeyType, PPCSPPTextLayerSizeMode, PPCSPPTouchEvent, PPCSPPTouchEventAction, PPCSPPValueHistory<T>, PPCSPPValueHistoryCompanion, PPCSPPVar<T>, PPCSPPVarCompanion, PPCSPPVectorShape, PPCSPPVectorShapeType, PPCSPPVerticalAlign, PPCSPlatform, PPCSProfileOptions, PPCSReaderOptions, PPCSReplayData, PPCSReplayDataCompanion, PPCSReplayDataSerializer, PPCSReplayDataVersionCompanion, PPCSReplayOptions, PPCSReplayer, PPCSScreenInfo, PPCSStringPool;
...
- (instancetype)initWithNamespace:(NSString *)namespace_ nsId:(NSString *)nsId parent:(PPCSPPContainerLayer * _Nullable)parent __attribute__((swift_name("init(namespace:nsId:parent:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)initWithNamespace:(NSString *)namespace_ nsId:(PPCSPPId *)nsId name:(NSString *)name __attribute__((swift_name("init(namespace:nsId:name:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly, getter=namespace) NSString *namespace_ __attribute__((swift_name("namespace_")));
@property (readonly) PPCSPPId *nsId __attribute__((swift_name("nsId")));
@end
...
@interface PPCSPPSharedComponentContainerLayer : PPCSPPContainerLayer
- (instancetype)initWithNamespace:(NSString *)namespace_ nsId:(NSString *)nsId parent:(PPCSPPContainerLayer * _Nullable)parent templateRoot:(PPCSPPContainerLayer *)templateRoot materializeChildren:(void (^)(PPCSPPSharedComponentContainerLayer *))materializeChildren __attribute__((swift_name("init(namespace:nsId:parent:templateRoot:materializeChildren:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithNamespace:(NSString *)namespace_ nsId:(NSString *)nsId parent:(PPCSPPContainerLayer * _Nullable)parent __attribute__((swift_name("init(namespace:nsId:parent:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) PPCSPPSharedComponentContainerLayerCompanion *companion __attribute__((swift_name("companion")));
- (void)addChildLayerChildLayer:(PPCSPPLayer *)childLayer __attribute__((swift_name("addChildLayer(childLayer:)")));
- (void)addChildLayerIndex:(int32_t)index layer:(PPCSPPLayer *)layer __attribute__((swift_name("addChildLayer(index:layer:)")));
- (void)onBeforeIterateChildren __attribute__((swift_name("onBeforeIterateChildren()")));
- (void)reorderOldIndex:(int32_t)oldIndex newIndex:(int32_t)newIndex __attribute__((swift_name("reorder(oldIndex:newIndex:)")));
...
@interface PPCSPPSharedComponentContainerLayerCompanion : PPCSBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) PPCSPPSharedComponentContainerLayerCompanion *shared __attribute__((swift_name("shared")));
@end
...
@property (readonly) PPCSPPJsonPool *jsonPool __attribute__((swift_name("jsonPool")));
...
- (PPCSPPPieModel *)readPieJson:(id<PPCSPPJson>)json engineObserver:(id<PPCSPPEngineObserver> _Nullable)engineObserver gestureOptions:(PPCSPPPlayControlGestureOptions *)gestureOptions disableVariableDisplay:(BOOL)disableVariableDisplay disableDeviceFrameDisplay:(BOOL)disableDeviceFrameDisplay forceDisableWatermark:(BOOL)forceDisableWatermark options:(PPCSReaderOptions *)options __attribute__((swift_name("readPie(json:engineObserver:gestureOptions:disableVariableDisplay:disableDeviceFrameDisplay:forceDisableWatermark:options:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReaderOptions")))
@interface PPCSReaderOptions : PPCSBase
...
- (PPCSReaderOptions *)doCopyDiscardJsonAfterLoad:(BOOL)discardJsonAfterLoad __attribute__((swift_name("doCopy(discardJsonAfterLoad:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface PPCSPPId : PPCSBase
- (instancetype)initWithRaw:(NSString *)raw __attribute__((swift_name("init(raw:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) PPCSPPIdCompanion *companion __attribute__((swift_name("companion")));
- (PPCSPPId *)doCopyRaw:(NSString *)raw __attribute__((swift_name("doCopy(raw:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface PPCSPPIdCompanion : PPCSBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithJson:(PPCSKotlinx_serialization_jsonJsonElement * _Nullable)json pool:(PPCSPPJsonPool * _Nullable)pool __attribute__((swift_name("init(json:pool:)"))) __attribute__((objc_designated_initializer));
...
- (NSString *)toJsonString __attribute__((swift_name("toJsonString()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (PPCSPPJsonImpl *)withPoolNewPool:(PPCSPPJsonPool *)newPool __attribute__((swift_name("withPool(newPool:)")));
@property (readonly) PPCSKotlinx_serialization_jsonJsonElement * _Nullable json __attribute__((swift_name("json")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PPJsonPool")))
@interface PPCSPPJsonPool : PPCSBase
...
- (id<PPCSPPJson> _Nullable)getElement:(PPCSKotlinx_serialization_jsonJsonElement * _Nullable)element __attribute__((swift_name("get(element:)")));
- (id<PPCSPPJson>)getOrCreateElement:(PPCSKotlinx_serialization_jsonJsonElement *)element __attribute__((swift_name("getOrCreate(element:)")));
- (void)putElement:(PPCSKotlinx_serialization_jsonJsonElement *)element impl:(id<PPCSPPJson>)impl __attribute__((swift_name("put(element:impl:)")));
- (int32_t)size __attribute__((swift_name("size()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PPJsonStringBacked")))
@interface PPCSPPJsonStringBacked : PPCSBase <PPCSPPJson>
- (instancetype)initWithRaw:(NSString *)raw pool:(PPCSPPJsonPool * _Nullable)pool __attribute__((swift_name("init(raw:pool:)"))) __attribute__((objc_designated_initializer));
- (BOOL)hasKey:(NSString *)key __attribute__((swift_name("has(key:)")));
- (NSSet<NSString *> *)keySet __attribute__((swift_name("keySet()")));
- (id _Nullable)optKey:(NSString *)key __attribute__((swift_name("opt(key:)")));
- (id<PPCSPPJson> _Nullable)optObjectKey:(NSString *)key __attribute__((swift_name("optObject(key:)")));
...
- (NSString *)toJsonString __attribute__((swift_name("toJsonString()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (PPCSPPJsonStringBacked *)withPoolNewPool:(PPCSPPJsonPool *)newPool __attribute__((swift_name("withPool(newPool:)")));
@end
...
@interface PPCSStringPool : PPCSBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)stringPool __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) PPCSStringPool *shared __attribute__((swift_name("shared")));
- (void)clearPool __attribute__((swift_name("clearPool()")));
- (int32_t)getPoolSize __attribute__((swift_name("getPoolSize()")));
