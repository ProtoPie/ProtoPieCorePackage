...
- (id<PPCSPPJson>)getOrCreateElement:(PPCSKotlinx_serialization_jsonJsonElement * _Nullable)element __attribute__((swift_name("getOrCreate(element:)")));
