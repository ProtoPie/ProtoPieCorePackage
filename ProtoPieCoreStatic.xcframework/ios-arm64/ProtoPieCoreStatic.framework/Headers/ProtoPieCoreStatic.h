...
- (instancetype)initWithJsonString:(NSString *)jsonString pool:(PPCSPPJsonPool * _Nullable)pool __attribute__((swift_name("init(jsonString:pool:)"))) __attribute__((objc_designated_initializer));
